...
namespace UnityStandardAssets.CinematicEffects
{
    ...
    public class RFX1_Bloom : MonoBehaviour
    {
        ...
        public struct Settings
        {
            ...
            [RFX1_Min(0f), Tooltip("Amount of lens dirtiness.")]
        ...
        public Shader shader
        {
            get
            {
                if (m_Shader == null)
                {
                    const string shaderName = "Hidden/Image Effects/Cinematic/RFX1_Bloom";
        ...
        {
            if (!RFX1_ImageEffectHelper.IsSupported(shader, true, false, this))
                enabled = false;
        }
